...
| **The Oracle** (10 scenarios) | Branching troubleshooting trials based on real incidents: No valid host, DHCP failures, floating IPs, MTU, Fernet keys, stuck volumes, RabbitMQ partitions, live migration, Octavia, noisy neighbours. |
